...
function clickHandler(event) {
    ...
    /* while (divProd.firstChild){
        divProd.removeChild(divProd.firstChild);
    } */
    /* let clareDiv = '';
    divProd.insertAdjacentHTML('afterbegin', clareDiv) */
    divProd.innerHTML = "";
...
function showCategory(category) {
    ...
    productByCat.forEach(function(prod){
        div = div + getProductMarkup(prod);
    });
    divProd.insertAdjacentHTML('afterbegin', div);
}
